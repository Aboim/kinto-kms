...
pub fn generate_pdf_report(
    ...
    current_layer.use_text("DATA", 7.0, Mm(14.0), Mm(y_pos), &font);
    current_layer.use_text("KMs", 7.0, Mm(42.0), Mm(y_pos), &font);
    current_layer.use_text("Diferenca", 7.0, Mm(62.0), Mm(y_pos), &font);
    current_layer.use_text("Dias", 7.0, Mm(82.0), Mm(y_pos), &font);
    current_layer.use_text("KM/Dia", 7.0, Mm(98.0), Mm(y_pos), &font);
    ...
    for rec in &sorted {
        ...
        current_layer.use_text(&rec.date, 7.0, Mm(14.0), Mm(y_pos), &font);
        current_layer.use_text(
            &format!("{:.0}", rec.kms),
            7.0,
            Mm(42.0),
